...
export const GlobalTelemetrySankey: React.FC = () => {
  ...
  return (
    <div className="bg-[#030914] border border-[#0e2a4a] rounded-2xl p-6 shadow-xl relative flex flex-col">
      {/* Header */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4 pb-3 border-b border-[#0e2a4a]">
        ...
        {selectedNode && (
          <button
            ...
            className="px-2.5 py-1 text-[11px] font-mono-code rounded bg-[#050e1c] hover:bg-[#0a1b33] text-slate-300 border border-[#0e2a4a] transition-colors self-start sm:self-auto cursor-pointer"
          >
      ...
      {/* SVG Canvas */}
      <div className="w-full aspect-[18/10] bg-[#070b13] rounded-xl border border-[#0e2a4a]/80 p-3 relative overflow-hidden">
        {/* Column Headings */}
        ...
        {(hoveredLink || selectedNode) && (
          <div className="absolute bottom-3 left-3 right-3 bg-slate-900/95 border border-[#0d223a] rounded-xl p-3 shadow-2xl text-xs font-mono-code flex flex-col sm:flex-row sm:items-center justify-between gap-3 animate-fade-in backdrop-blur-md">
            <div>
              {hoveredLink ? (
                <>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] px-2 py-0.5 rounded bg-[#050e1c] text-cyan-300">
                ...
                <>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] px-1.5 py-0.2 rounded bg-[#050e1c] text-slate-300 uppercase">
