...
export const TeamDossierCard: React.FC<TeamDossierCardProps> = ({
  ...
  return (
    <div className="bg-[#050b14] border border-[#1e293b] p-5 shadow-xl flex-1 flex flex-col justify-between">
      <div className="space-y-4">
        ...
        <div className="flex items-start justify-between gap-3 pb-3 border-b border-[#1e293b]">
          <div className="flex items-center gap-2.5">
            <div 
              className="w-8 h-8 flex items-center justify-center font-mono-code font-bold text-xs text-slate-900 shadow-md"
          ...
          <span className={`px-2.5 py-1 text-[11px] font-mono-code font-bold uppercase border ${statusBg}`}>
            {statusLabel}
          </span>
        </div>
        ...
        <div className="grid grid-cols-2 gap-2 text-xs">
          <div className="bg-[#010613] p-2.5 border border-[#1e293b]">
        ...
        <div className="bg-[#010613] p-3 border border-[#1e293b] text-xs">
        ...
        <div className="pt-2 border-t border-[#1e293b] space-y-2.5 font-mono-code text-xs">
          ...
          <div>
            ...
            <div className="w-full h-2 bg-[#010613] border border-[#1e293b] overflow-hidden">
              <div 
      ...
      <div className="pt-4 mt-4 border-t border-[#1e293b] flex items-center gap-2">
        <button
          ...
          className="flex-1 py-2 px-3 bg-[#010613] hover:bg-[#1e293b] text-slate-200 border border-[#1e293b] text-xs font-medium flex items-center justify-center gap-1.5 transition-colors cursor-pointer"
        >
        ...
        <button
          ...
          className="flex-1 py-2 px-3 bg-emerald-500/15 hover:bg-emerald-500/25 text-emerald-300 border border-emerald-500/40 text-xs font-medium flex items-center justify-center gap-1.5 transition-colors cursor-pointer"
        >
