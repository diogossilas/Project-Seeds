...
export const HeroOperationalChart: React.FC<HeroOperationalChartProps> = ({
  ...
  return (
    <div className="bg-[#0c1220] border border-slate-800 rounded-xl p-4 sm:p-6 shadow-xl relative overflow-hidden">
      ...
      <div className="absolute -left-16 -top-16 w-80 h-80 bg-emerald-500/5 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-slate-800/80">
        <div>
          <div className="flex items-center gap-2">
            <span className="px-2.5 py-0.5 rounded bg-cyan-500/15 text-cyan-300 border border-cyan-500/40 text-xs font-mono-code font-bold uppercase flex items-center gap-1.5">
        ...
        <div className="flex items-center gap-2 self-start md:self-auto">
          <div className="flex rounded-lg bg-[#070b14] border border-slate-800 p-1">
            <button
              id="hero-tab-radar"
              onClick={() => handleTabChange('radar')}
              className={`px-2.5 sm:px-3 py-1.5 rounded-md text-xs font-mono-code font-semibold flex items-center gap-1.5 transition-all cursor-pointer ${
                activeTab === 'radar'
      ...
      <div className="relative z-10 pt-4">
        ...
        {activeTab === 'radar' && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
            ...
            <div className="lg:col-span-5 bg-[#080d16] border border-slate-800 rounded-xl p-4 space-y-3.5">
              <div className="flex items-center justify-between pb-2 border-b border-slate-800">
                ...
                <span className="px-2 py-0.5 rounded bg-slate-800 text-emerald-400 font-mono-code text-xs font-bold border border-slate-700">
                  ...
                  {TEAMS_DATA.map((t) => {
                    ...
                    return (
                      <button
                        ...
                        className={`px-2 py-1 rounded text-[11px] font-mono-code font-bold transition-all cursor-pointer border ${
                          isSelected
        ...
        {activeTab === 'timeline' && (
          <div className="space-y-4">
            <div className="bg-[#080d16] border border-slate-800 rounded-xl p-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-5 gap-3">
                {timelinePhases.map((phase, idx) => (
                  <div 
                    key={idx}
                    className="bg-[#0c1424] border border-slate-800 rounded-lg p-3 flex flex-col justify-between"
                  >
                    <div>
            ...
            {/* Strategic Insight */}
            <div className="p-3 rounded-lg bg-emerald-500/10 border border-emerald-500/30 text-xs font-sans text-slate-200 flex items-center gap-3">
        ...
        {/* ============================================================ */}
        {activeTab === 'comparison' && (
          <div className="bg-[#080d16] border border-slate-800 rounded-xl p-4 overflow-x-auto">
                    ...
                    >
                      ...
                      <td className="py-2.5 text-center">
                        <span className={`px-2 py-0.5 rounded text-[11px] font-bold ${
                          isRyugu ? 'bg-rose-500/20 text-rose-300' :
                          isFuji ? 'bg-cyan-500/20 text-cyan-300' : 'bg-emerald-500/20 text-emerald-300'
                        }`}>
                          {team.survivalCount}
                        </span>
                      </td>
                      ...
                      <td className="py-2.5 text-right">
                        <button
                          ...
                          className="px-2 py-0.5 rounded bg-slate-800 hover:bg-cyan-500/20 hover:text-cyan-300 text-slate-300 text-[10px] border border-slate-700 transition-colors cursor-pointer"
                        >
                          Inspecionar
                        </button>
                      </td>
